...
export const reviews: Review[] = [
  ...
  },
  {
    name: "Jordan T.",
    rating: 5,
    text: "The atmosphere here is something else. It's calm, aesthetic, and feels like a little escape. I used to struggle to find a place to work in Walsall. BrewKraft sorted that for me.",
